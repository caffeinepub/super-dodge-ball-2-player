...
function App() {
  ...
  const stateRef = reactExports.useRef(makeInitialState());
  const [score, setScore] = reactExports.useState({ p1: 0, p2: 0 });
  ...
  reactExports.useEffect(() => {
    ...
    function drawPlayer(p, color, flash) {
      const alpha = flash > 0 && Math.floor(Date.now() / 80) % 2 === 0 ? 0.35 : 1;
      ctx.save();
    ...
    function drawGameOver() {
      ...
      ctx.fillRect(0, 0, CANVAS_W, CANVAS_H);
      const winnerText = s.p1.hits >= MAX_HITS ? "⚡ PLAYER 2 WINS! ⚡" : "⚡ PLAYER 1 WINS! ⚡";
      ctx.save();
    ...
    function update() {
      ...
      for (let i = s.balls.length - 1; i >= 0; i--) {
        ...
        if (b.speed > 0 && b.x + 8 > s.p2.x && b.x - 8 < s.p2.x + s.p2.w && b.y + 8 > s.p2.y && b.y - 8 < s.p2.y + s.p2.h) {
          s.p2.hits++;
          s.p2Flash = 20;
          s.balls.splice(i, 1);
        ...
        if (b.speed < 0 && b.x + 8 > s.p1.x && b.x - 8 < s.p1.x + s.p1.w && b.y + 8 > s.p1.y && b.y - 8 < s.p1.y + s.p1.h) {
          s.p1.hits++;
          s.p1Flash = 20;
          s.balls.splice(i, 1);
          setScore({ p1: s.p1.hits, p2: s.p2.hits });
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      style: {
        background: "linear-gradient(160deg, #0d0d1a 0%, #0a1a0f 50%, #0d0d1a 100%)"
      },
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-4 text-center", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "p",
            {
              ...
              children: "2 PLAYER EDITION"
            }
          )
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "score-badge flex items-center gap-6 px-6 py-3 rounded-xl mb-3", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { color: "oklch(0.4 0.04 260)", fontWeight: 700 }, children: "VS" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "span",
              {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            style: {
              ...
              borderRadius: "8px",
              boxShadow: "0 0 40px oklch(0.4 0.15 145 / 0.4), 0 0 80px oklch(0.3 0.1 145 / 0.2)",
              overflow: "hidden"
            },
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-4 grid grid-cols-2 gap-4 w-full max-w-2xl px-4", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              "First to receive",
              " ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { style: { color: "rgba(255,255,255,0.55)" }, children: "3 hits" }),
              " ",
              "loses  •  Press",
              " ",
              /* @__PURE__ */ jsxRuntimeExports.jsx(
